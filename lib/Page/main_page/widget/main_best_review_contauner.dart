...
class BestReview3 extends StatefulWidget {
  final BestReviewModel reviewsData;
...
class _BestReview3State extends State<BestReview3> {
  ...
  void initState() {
    super.initState();
    editText();
    recommendCount = widget.reviewsData.recommendCount;
    _toggleValue = widget.reviewsData.recommendation;
  }

  void editText() {
    setState(() {
      givenTimeStr = widget.reviewsData.writeDate;
      newText = formatTimeDifference(givenTimeStr);
    });
  }

  void togglIcon() async {
    result = await recommendReviewDio(widget.reviewsData.reviewId);
    if (result['success']) {
      setState(() {
        _toggleValue = true;
        ...
        return InkWell(
          ...
          onTap: () {
            Navigator.pushNamed(context, '/StoreReviewContainer',
                arguments: widget.reviewsData.marketId);
            context
                .read<ReviewPageNavigatorBloc>()
                .add(NextPage(widget.reviewsData.marketId));
          },
          child: Row(
            children: [
              ClipRRect(
                ...
                child: SizedBox(
                  ...
                  child: CachedNetworkImage(
                    imageUrl: widget.reviewsData.reviewImage,
                    fit: BoxFit.cover,
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      Row(
                        children: [
                          Container(
                              ...
                              child: CachedNetworkImage(
                                imageUrl: widget.reviewsData.reviewerImage,
                                fit: BoxFit.cover,
                                memCacheHeight: (30 *
                                        MediaQuery.of(context).devicePixelRatio)
                                    .round(),
                          ...
                          SizedBox(
                            ...
                            child: Text(
                              widget.reviewsData.reviewerEmail,
                      ...
                      Expanded(
                        child: Text(
                          widget.reviewsData.reviewContent,
                          maxLines: 3,
                          overflow: TextOverflow.ellipsis,
                          style: const TextStyle(
                            color: Colors.black,
